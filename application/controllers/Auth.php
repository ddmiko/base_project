...
class Auth extends CI_Controller {
	...
	public function registration(){
		...
		$this->form_validation->set_rules('password1', 'Password', 'required|trim|min_length[3]|matches[password2]',['matches'=>'Password does not match!',
	...
	private function _sendEmail($token, $type){
		...
		$config = [
			...
			'smtp_user' => 'projectddmiko@gmail.com',
			'smtp_pass' => 'Rock24Chrome5',
			'smtp_port' => 465,
			'mailtype'  => 'html',
			'charset'   => 'utf-8',
			'newline'   => "\r\n"
		...
		$this->email->from('projectddmiko@gmail.com', 'Project');
